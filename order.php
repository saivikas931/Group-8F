...
?>
	...
	<div class="site-main">
		...
		<h1 class="card-title m-5" style="font-size: 30px;padding-top:20px; border-bottom:1px solid black">C M S - Order List</h1>
...
<script>
    ...
    if (items && items.length > 0) {
        // Display the first 8 items, you can modify this based on your pagination needs
        var itemsToDisplay = items.slice(0, 8);
            ...
            var card = `
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success add-to-cart-btn" data-item-id="${item.ItemID}">Add to Cart</button>
                    </div>
                </div>`;
...
// Example of a click event for the "Add to Cart" button
// Example of a click event for the "Add to Cart" button
$(document).on("click", ".add-to-cart-btn", function () {
    ...
    console.log("Item with ID added to cart:", itemId);
